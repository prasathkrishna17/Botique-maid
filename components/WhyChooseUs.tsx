...
export default function WhyChooseUs() {
  const features = [
    {
      icon: CheckCircle,
      title: "Owner-Led Company",
      description:
        "Owner-Led for 10+ years of experience and expertise.",
    },
    {
      icon: TrendingUp,
      title: "High Standard Cleaning",
      description:
        "Consistent, High standard cleaning tailored to your home.",
    },
    {
      icon: Calendar,
      title: "Seamless Booking",
      description:
        "Book under 60 seconds & Get your quote instantly.",
    },
    {
      icon: Users,
      title: "Trusted Professionals",
      description:
        "Every team member is background checked and insured.",
    },
  ];
    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Why Choose <span className="text-primary">Botique Maid?</span> 
          </motion.h2>
          <motion.p
          ...
          >
            We provide everything you need on your home cleaning.
          </motion.p>
        </div>
